...
<?php if ( 'ap_settings[advanced][field-import-button]' == $field['label_for'] ) : ?>
	<input type="button" onclick="alert('import products'); return false;" id="<?php esc_attr_e( 'ap_settings[advanced][field-import-button]' ); ?>" value="Import products" class="button-primary" name="<?php esc_attr_e( 'ap_settings[advanced][field-import-button]' ); ?>" />
<?php else : ?>
