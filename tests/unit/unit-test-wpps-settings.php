...
if ( ! class_exists( 'UnitTestWPPS_Settings' ) ) {
	class UnitTestWPPS_Settings extends UnitTestCase {
		...
		public function test_magic_set() {
			...
			$this->assertEqual( $this->WPPS_Settings->settings['db-version'], AvanPress::VERSION );
			...
			$this->WPPS_Settings->settings = array( 'db-version' => AvanPress::VERSION );
			...
			$this->WPPS_Settings->settings['db-version'] = AvanPress::VERSION;
		}
